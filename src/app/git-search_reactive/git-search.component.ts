...
export class GitSearchComponent implements OnInit {
  ...
  /*
  a custom validator to check for special characters in the fields:
  a function that returns either an object
  marking that the field is invalid or null
  if the item is valid (which we are determining by
  performing a regex against a set of invalid characters) */
